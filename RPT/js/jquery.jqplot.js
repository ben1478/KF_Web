...
(function($) {
    ...
    $.jqplot.config = {
        ...
        defaultColors: ["#66B3FF", "#EAA228", "#CCCCFF", "#E1C4C4", "#FFCC99", "#FFFF66", "#FFCCCC", "#99CC33", "#d8b83f", "#ff5800", "#0085cc", "#c747a3", "#cddf54", "#FBD178", "#26B4E3", "#bd70c7"],
                    ...
                    case $.jqplot.BarRenderer:
                        ...
                        for (j=0; j<s._barPoints.length; j++) {
                            ...
                            if (x>points[0][0] && x<points[2][0] && (y>points[2][1] && y<points[0][1] || y<points[2][1] && y>points[0][1])) {
                                return { seriesIndex: s.index, pointIndex: j, gridData: p, data: plot.data[0][j], points:s._barPoints[j]};
                            }
                        }
                        break;
    ...
    */
    ...
    $.jqplot.TableLegendRenderer.prototype.addrow = function (label, color, pad, reverse) {
        ...
        if (this.showLabels) {
            ...
            td.attr('id', "lbl"+label);
            td.attr('Bcolor', color);
