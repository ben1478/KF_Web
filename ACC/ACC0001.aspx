<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ACC0001.aspx.cs" Inherits="KF_Web.ACC0001" %>
<!DOCTYPE html>
                                            ...
                                            <div class="panel-body PanelLeft">
                                                <table id="BaseCtrl" class="" style="width: 100%; font-size: small; border-color: black; border-collapse: collapse;">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td class="lbl" style="width: 30%;">
                                                                <label class="col-lg-2 control-label AllowEmpty " id="lblDisplayName">*帳號名稱　:</label>
                                                            </td>
                                                            <td style="width: 70%; text-align: left;">
