<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GeneratorWebMaintain.aspx.cs" Inherits="KF_Web.GeneratorWebMaintain" %>
...
<form id="FormMaintain" runat="server">
    ...
    <img class="mw30 br64 mr15" alt="avatar" src="img/avatars/1.jpg"/><asp:Label ID="UserInfo" runat="server"  Text=""></asp:Label> <asp:TextBox ID="txtAccount" style="display:none"  ReadOnly="true" runat="server" AutoPostBack="True"></asp:TextBox>
    ...
    <select id="selLanguage" runat="server"  onchange="GetLanguageByPage()">
     ...
     <div class='panel' id='MaintainForm' runat="server"  ></div>
